...
class _$CoinImpl implements _Coin {
  ...
  @override
  String toString() {
    return 'Coin(id: $id, name: $name, symbol: $symbol, rank: $rank, isNew: $isNew, isActive: $isActive, type: $type)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, symbol, rank, isNew, isActive, type);
